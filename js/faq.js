...
/*document.querySelectorAll('.faq-block').forEach(el => 
    el.addEventListener('click', () =>
    el.childNodes[1].childNodes[3].classList.toggle('display-none')
    )
  );

  document.querySelectorAll('.faq-block').forEach(el => 
    el.addEventListener('click', () =>
    el.childNodes[1].childNodes[4].classList.toggle('display-block')
    )
  ); */
 ...
 // );
  ...
  document.querySelectorAll('.faq-block').forEach(el => 
    el.addEventListener('click', () =>
    el.classList.toggle('faq-block-show')
    )
  );

  document.querySelectorAll('.faq-block').forEach(el => 
    el.addEventListener('click', () =>
    el.childNodes[1].childNodes[3].classList.toggle('faq-btn-open-animation')
    )
  );
  document.querySelectorAll('.faq-block').forEach(el => 
    el.addEventListener('click', () =>
    el.childNodes[1].childNodes[3].childNodes[1].classList.toggle('faq-btn-open-animation__span')
    )
  );